...
export default function Stats() {
  return (
    <div className=' mt-20'>
            <h1 className="text-2xl w-[80%] mx-auto mb-24 md:text-4xl xl:text-5xl font-bold leading-10 text-gray-800 text-center xl:text-left md:mt-0">Every Week</h1>
	...
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 dark:text-gray-100">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 dark:bg-sky-400">
