...
export default function WeOffer() {
  return (
    <div className="w-full md:py-12 py-9">
            <h1 className="text-2xl w-[77%] mx-auto mb-24 md:text-4xl xl:text-5xl font-bold leading-10 text-gray-800 text-center xl:text-left md:mt-0 mt-4">Why Us?</h1>

            <div className=" w-[90%] mx-auto grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 py-10 md:px-12 px-4">
                ...
                <div>
                    ...
                    <h3 className=" text-xl leading-5 font-semibold text-gray-800 lg:mt-10 mt-8 ">Fast Delivery</h3>
                </div>
                ...
                <div>
                    ...
                    <h3 className=" text-xl leading-5 font-semibold text-gray-800 lg:mt-10 mt-8 ">Flexible Orders</h3>
                </div>
